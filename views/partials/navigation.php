<header>
    <nav>
        <input type="checkbox" id="sidebar" name="sidebar" onclick="lockScroll();">
        <ul class="nav">
            ...
            <ul class="normalize">
                ...
                <li><a href='index.php?page=user&show=account'><i class='user'></i></a></li>
        ...
        <ul class="container sidebar">
            <div class="column">
                <ul>
                    ...
                    <li><a href='admin/index.php'><h1 class="smoosh">DASHBOARD</h1></a></li>
                    <?php endif; ?>
