	...
	<div class="container">
		...
		<div class="row">
			...
			<section class="main">
				...
				<form class="form" action="index.php?page=login&show=sign_up" method="post" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="group-line mtb-1">
						...
						<div class="group group-minor ml-1 mr-1 m-mt-2">
							...
							<input class="control mt-1" type="text" name="city" id="city" value="<?= isset($_SESSION['old_inputs']) ? htmlspecialchars($_SESSION['old_inputs']['city']) : '' ?><?= isset($user) ? htmlspecialchars($user['city']) : '' ?>" />
						</div>
						<div class="group group-minor ml-1 m-mt-2">
							<label for="country"><h5 class="italic">COUNTRY</h5></label>
							<input class="control mt-1" type="text" name="country" id="country" value="<?= isset($_SESSION['old_inputs']) ? htmlspecialchars($_SESSION['old_inputs']['country']) : '' ?><?= isset($user) ? htmlspecialchars($user['country']) : '' ?>" />
						</div>
					</div>
					<div class="group-line mtb-1">
						<div class="group mr-1">
						...
						<div class="group ml-1 m-mt-2">
							...
							<input class="control mt-1"  type="password" size="24" name="c_password" id="c_password" value="<?= isset($_SESSION['old_inputs']) ? $_SESSION['old_inputs']['c_password'] : '' ?>" />
						</div>
					</div>
					<input class="btn btn-large mtb-1" type="submit" value="SIGN UP" />
				</form>
			</section>
		</div>
	</div>
